    ...
    return (
        <header style={styles.header}>
            <div style={styles.profile}>
                <img src="https://via.placeholder.com/40" alt="Profile" style={styles.profileImg} />
                <span>{usernName}</span>
            </div>
        </header>
    );
...
const Sidebar = ({ onSelect }) => {
    return (
        <aside style={styles.sidebar}>
            <ul style={styles.nav}>
                <li style={styles.navItem} onClick={() => onSelect('dashboard')}>Dashboard</li>
                <li style={styles.navItem} onClick={() => onSelect('create')}>Provide Scholarship</li>
                <li style={styles.navItem} onClick={() => onSelect('settings')}>Settings</li>
            </ul>
        </aside>
    );
};
    ...
    return (
        <form style={styles.form} onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
                ...
                <input type="text" name="website" value={formData.website} onChange={handleChange} style={styles.input} required />
            </div>
            <div style={styles.formGroup}>
                <label style={styles.label}>Contact Email</label>
                <input type="email" name="contactEmail" value={formData.contactEmail} onChange={handleChange} style={styles.input} required />
            </div>
            <div style={styles.formGroup}>
                <label style={styles.label}>Registration Number</label>
                <input type="text" name="registration_number" value={formData.registration_number} onChange={handleChange} style={styles.input} required />
            </div>
            <div style={styles.formGroup}>
                <label style={styles.label}>Year Established</label>
                <input type="number" name="year_established" value={formData.year_established} onChange={handleChange} style={styles.input} required />
            </div>
            <div style={styles.formGroup}>
                <label style={styles.label}>Provider Type</label>
                <select name="provider_type" value={formData.provider_type} onChange={handleChange} style={styles.select} required>
            ...
            <div style={styles.formGroup}>
                ...
                <input type="text" name="pin_code" value={formData.pin_code} onChange={handleChange} style={styles.input} required />
            </div>
            <div style={styles.formGroup}>
            ...
            <div style={styles.formGroup}>
                ...
                <input type="file" name="image" onChange={handleFileChange} style={styles.inputFile} />
            </div>
